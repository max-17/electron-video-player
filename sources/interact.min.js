...
!(function (t) {
    ...
    function o(t) {
        ...
        o.ownerDocument !== t.document && 'function' == typeof t.wrap && t.wrap(o) === o && (t = t.wrap(t)),
            (e.window = r = t);
    }
            ...
            listeners: {
                ...
                'auto-start:check': function (t) {
                    ...
                    if (
                        ...
                        return (
                            (t.action = { name: 'drag', axis: 'start' === o.lockAxis ? o.startAxis : o.lockAxis }), !1
                        );
                },
            },
    ...
    var x = {
            init: function (t) {
                ...
                (x.supportsTouch =
                    'ontouchstart' in t ||
                    (i.default.func(t.DocumentTouch) && h.default.document instanceof t.DocumentTouch)),
                    (x.supportsPointerEvent = !1 !== n.pointerEnabled && !!h.default.PointerEvent),
                    (x.isIOS = /iP(hone|od|ad)/.test(n.platform)),
                    (x.isIOS7 = /iP(hone|od|ad)/.test(n.platform) && /OS 7[^\d]/.test(n.appVersion)),
                    (x.isIe9 = /MSIE 9/.test(n.userAgent)),
                    (x.isOperaMobile = 'Opera' === n.appName && x.supportsTouch && /Presto/.test(n.userAgent)),
                    ...
                    (x.pEventTypes = x.supportsPointerEvent
                        ...
                        : null),
                    (x.wheelEvent =
                        h.default.document && 'onmousewheel' in h.default.document ? 'mousewheel' : 'wheel');
            },
            supportsTouch: null,
                                ...
                                if (s !== l) {
                                    ...
                                    (v = i),
                                        ...
                                        (parseInt(e.getWindow(v).getComputedStyle(v).zIndex, 10) || 0) >=
                                            (parseInt(e.getWindow(g).getComputedStyle(g).zIndex, 10) || 0) && (n = o);
                            else n = o;
                    } else n = o;
            }
            var v, g;
    ...
    Object.defineProperty(k, '__esModule', { value: !0 }),
        ...
        (k.resolveRectLike = function (t, e, n, r) {
            ...
            return (
                ...
                i.default.element(a) && (a = (0, _.getElementRect)(a)),
                a
            );
        }),
    ...
    Object.defineProperty(R, '__esModule', { value: !0 }),
        (R.default = function t(e, n, r) {
            if (((r = r || {}), i.default.string(e) && -1 !== e.search(' ') && (e = z(e)), i.default.array(e)))
    ...
    Object.defineProperty(F, '__esModule', { value: !0 }),
        (F.default = void 0),
        (X.prefixedPropREs = { webkit: /(Movement[XY]|Radius[XY]|RotationAngle|Force)$/, moz: /(Pressure)$/ });
    var Y = X;
    F.default = Y;
    var B = {};
    function W(t) {
    ...
    function U(t, e) {
        return (
            (e = e || { x: 0, y: 0 }),
            b.default.isOperaMobile && W(t)
                ? (L('screen', t, e), (e.x += window.scrollX), (e.y += window.scrollY))
                : L('page', t, e),
            e
        );
    }
    ...
    var K = (function () {
        function t(e) {
            !(function (t, e) {
                ...
                H(this, 'currentTarget', void 0),
                H(this, 'interactable', void 0),
                H(this, '_interaction', void 0),
                H(this, 'timeStamp', void 0),
                H(this, 'immediatePropagationStopped', !1),
                H(this, 'propagationStopped', !1),
                (this._interaction = e);
        }
        var e, n;
        return (
    ...
    ($.BaseEvent = K),
        Object.defineProperty(K.prototype, 'interaction', {
            get: function () {
    ...
    Object.defineProperty(Z, '__esModule', { value: !0 }),
        (Z.find = Z.findIndex = Z.from = Z.merge = Z.remove = Z.contains = void 0),
    ...
    var lt = (function (t) {
        ...
        function a(t, e, n) {
            ...
            !(function (t, e) {
                ...
                st(it((r = i.call(this, e._interaction))), 'target', void 0),
                st(it(r), 'dropzone', void 0),
                st(it(r), 'dragEvent', void 0),
                st(it(r), 'relatedTarget', void 0),
                st(it(r), 'draggable', void 0),
                st(it(r), 'timeStamp', void 0),
                st(it(r), 'propagationStopped', !1),
                st(it(r), 'immediatePropagationStopped', !1);
                        ...
                        if (a.options.drop.enabled) {
                            ...
                            if (
                                !(
                                    ...
                                    (i.default.func(s) && !s({ dropzone: a, draggableElement: e }))
                                )
                            )
                                for (
    ...
    function vt(t, e) {
        ...
        e.leave && i.dropzone.fire(e.leave),
            ...
            e.deactivate && ct(r, e.deactivate),
    ...
    function ht(t, e) {
        ...
        if ('dragmove' === r.type || 'dragend' === r.type) {
            ...
            var a = r,
                s = dt(n, a, o);
            (i.rejected = i.rejected && !!s && s.dropzone === i.cur.dropzone && s.element === i.cur.element),
                ...
                t.usePlugin(c.default),
                        ...
                        return (function (t, e) {
                            if (i.default.object(e)) {
                                ...
                                return (
                                    ...
                                    i.default.func(e.ondropactivate) && t.on('dropactivate', e.ondropactivate),
                                    i.default.func(e.ondropdeactivate) && t.on('dropdeactivate', e.ondropdeactivate),
                                    i.default.func(e.ondragenter) && t.on('dragenter', e.ondragenter),
                                    i.default.func(e.ondragleave) && t.on('dragleave', e.ondragleave),
                                    i.default.func(e.ondropmove) && t.on('dropmove', e.ondropmove),
                    ...
                    (r.prototype.dropCheck = function (t, e, n, r, o, a) {
                        return (function (t, e, n, r, o, a, s) {
                            var l = !1;
                            if (!(s = s || t.getRect(a)))
                                return !!t.options.drop.checker && t.options.drop.checker(e, n, l, t, a, r, o);
                            ...
                            return (
                                v &&
                                    i.default.number(u) &&
                                    (l =
                                        (Math.max(0, Math.min(s.right, v.right) - Math.max(s.left, v.left)) *
                                            Math.max(0, Math.min(s.bottom, v.bottom) - Math.max(s.top, v.top))) /
                                            (v.width * v.height) >=
                                        u),
            ...
            listeners: {
                ...
                'interactions:after-action-start': function (t, e) {
                    ...
                    if ('drag' === n.prepared.name) {
                        ...
                        (o.activeDrops = null),
                            (o.events = null),
                            (o.activeDrops = ft(e, n.element)),
                            (o.events = pt(n, 0, r)),
                            o.events.activate &&
                                (ct(o.activeDrops, o.events.activate),
    ...
    function bt(t) {
        ...
        if ('gesture' === e.prepared.name) {
            ...
            if (((n.touches = [o[0], o[1]]), a))
                (n.distance = B.touchDistance(o, l)),
                    (n.box = B.touchBBox(o)),
                    (n.scale = 1),
                    (n.ds = 0),
                    (n.angle = B.touchAngle(o, l)),
                    (n.da = 0),
            ...
            (e.gesture.distance = n.distance),
                ...
                i.default.number(n.scale) && n.scale !== 1 / 0 && !isNaN(n.scale) && (e.gesture.scale = n.scale);
        }
    }
    ...
    function Pt(t, e, n, r, o, a, s) {
        ...
        if (!0 === e) {
            ...
            if (
                ((s = Math.min(s, Math.abs(('left' === t || 'right' === t ? l : u) / 2))),
    ...
    var St = {
            ...
            install: function (t) {
                ...
                (St.cursors = (function (t) {
                    ...
                    (St.defaultMargin = n.supportsTouch || n.supportsPointerEvent ? 20 : 10),
                    (r.prototype.resizable = function (e) {
                        return (function (t, e, n) {
                            return i.default.object(e)
                                ? ((t.options.resize.enabled = !1 !== e.enabled),
                                  ...
                                  i.default.bool(e.preserveAspectRatio)
                                      ...
                                      : i.default.bool(e.square) && (t.options.resize.square = e.square),
                                  t)
                                : i.default.bool(e)
                ...
                'auto-start:check': function (t) {
                    ...
                    if (o) {
                        ...
                        if (
                            l &&
                            l.enabled &&
                            (!e.pointerIsDown || !/mouse|pointer/.test(e.pointerType) || 0 != (a & l.mouseButtons))
                        ) {
            ...
            init: function (t) {
                if (((kt = t.requestAnimationFrame), (It = t.cancelAnimationFrame), !kt))
                    for (var e = ['ms', 'moz', 'webkit', 'o'], n = 0; n < e.length; n++) {
                        var r = e[n];
                        (kt = t[''.concat(r, 'RequestAnimationFrame')]),
                            (It =
    ...
    var zt = {
        ...
        start: function (t) {
            (zt.isScrolling = !0),
                jt.default.cancel(zt.i),
                (t.autoScroll = zt),
                (zt.interaction = t),
                (zt.prevTime = zt.now()),
                (zt.i = jt.default.request(zt.scroll));
        },
        stop: function () {
        ...
        onInteractionMove: function (t) {
            ...
            if (e.interacting() && zt.check(e.interactable, e.prepared.name))
                if (e.simulation) zt.x = zt.y = 0;
                    ...
                    (zt.x = o ? 1 : s ? -1 : 0),
                        (zt.y = a ? 1 : r ? -1 : 0),
                        zt.isScrolling || ((zt.margin = f.margin), (zt.speed = f.speed), zt.start(e));
                }
        },
    };
    function Ct(t, n, r) {
    ...
    var Ut = {
        ...
        install: function (t) {
            ...
            (e.prototype.getAction = function (e, n, r, o) {
                ...
                (e.prototype.allowFrom = (0, Yt.warnOnce)(function (t) {
                ...
                !(function (t, e) {
                    ...
                    (function (t, e) {
                        ...
                        if (n.pointerIsDown && !n.interacting() && n.pointerWasMoved && n.prepared.name) {
                            ...
                            o &&
                                r &&
                                (r.options[o].manualStart || !Ht(r, n.element, n.prepared, e)
                                    ? n.stop()
                                    : (n.start(n.prepared, r, n.element), Jt(n, e)));
                        }
                    })(t, e);
            },
                                    ...
                                    if (t !== n.interactable) {
                                        ...
                                        if (!o.manualStart && t.testIgnoreAllow(o, d, r)) {
                                            ...
                                            if (
                                                ...
                                                Vt.default.validateAction(i, t, d, r, e)
                                            )
                                                return t;
                                        }
                                    }
    ...
    var _e = (function () {
        function t(e) {
            !(function (t, e) {
                ...
                we(this, 'states', []),
                we(this, 'startOffset', { left: 0, right: 0, top: 0, bottom: 0 }),
                we(this, 'startDelta', void 0),
                we(this, 'result', void 0),
                we(this, 'endResult', void 0),
                we(this, 'edges', void 0),
                we(this, 'interaction', void 0),
                (this.interaction = e),
                (this.result = Pe());
        }
        var e, n;
            ...
            (n = [
                ...
                },
                {
                    ...
                    value: function (t) {
                        ...
                        for (
                            var i = r ? this.states.slice(r) : this.states, a = Pe(t.coords, t.rect), s = 0;
                            s < i.length;
                            s++
                        ) {
                            var l,
                ...
                },
                {
                    ...
                    value: function (t) {
                        ...
                        if (((this.result = i), !i.changed && (!o || o < this.states.length) && e.interacting()))
                            return !1;
                        if (t.modifiedCoords) {
    ...
    function Oe(t, e) {
        return t
            ? { left: e.x - t.left, top: e.y - t.top, right: t.right - e.x, bottom: t.bottom - e.y }
    ...
    var Fe = (function (t) {
        ...
        function a(t, e, n, r, o, s, l) {
            ...
            !(function (t, e) {
                ...
                Ce(Re((u = i.call(this, t))), 'target', void 0),
                Ce(Re(u), 'currentTarget', void 0),
                Ce(Re(u), 'relatedTarget', null),
                Ce(Re(u), 'screenX', void 0),
                Ce(Re(u), 'screenY', void 0),
                Ce(Re(u), 'button', void 0),
                Ce(Re(u), 'buttons', void 0),
                Ce(Re(u), 'ctrlKey', void 0),
                Ce(Re(u), 'shiftKey', void 0),
                Ce(Re(u), 'altKey', void 0),
                Ce(Re(u), 'metaKey', void 0),
                Ce(Re(u), 'page', void 0),
                Ce(Re(u), 'client', void 0),
                Ce(Re(u), 'delta', void 0),
                Ce(Re(u), 'rect', void 0),
                Ce(Re(u), 'x0', void 0),
                Ce(Re(u), 'y0', void 0),
                Ce(Re(u), 't0', void 0),
                Ce(Re(u), 'dt', void 0),
                Ce(Re(u), 'duration', void 0),
                Ce(Re(u), 'clientX0', void 0),
                Ce(Re(u), 'clientY0', void 0),
                Ce(Re(u), 'velocity', void 0),
                Ce(Re(u), 'speed', void 0),
                Ce(Re(u), 'swipe', void 0),
                Ce(Re(u), 'timeStamp', void 0),
                Ce(Re(u), 'axes', void 0),
                Ce(Re(u), 'preEnd', void 0),
                (o = o || t.element);
            var c = t.interactable,
                ...
                g = p
                    ? t.coords.start
                    : v
                    ? { page: h.page, client: h.client, timeStamp: t.coords.cur.timeStamp }
                    : t.coords.cur;
            return (
                ...
                v || ((u.page.x -= d.x), (u.page.y -= d.y), (u.client.x -= d.x), (u.client.y -= d.y)),
                (u.ctrlKey = e.ctrlKey),
                (u.altKey = e.altKey),
    ...
    Object.defineProperty(Xe, '__esModule', { value: !0 }),
        (Xe.PointerInfo = void 0),
        (Xe.PointerInfo = function t(e, n, r, o, i) {
            !(function (t, e) {
                if (!(t instanceof e)) throw new TypeError('Cannot call a class as a function');
            })(this, t),
                Ye(this, 'id', void 0),
                Ye(this, 'pointer', void 0),
                Ye(this, 'event', void 0),
                Ye(this, 'downTime', void 0),
                Ye(this, 'downTarget', void 0),
                (this.id = e),
                (this.pointer = n),
                (this.event = r),
                (this.downTime = o),
        ...
        qe = (function () {
            function t(e) {
                ...
                !(function (t, e) {
                    ...
                    Ve(this, 'interactable', null),
                    Ve(this, 'element', null),
                    Ve(this, 'rect', void 0),
                    Ve(this, '_rects', void 0),
                    Ve(this, 'edges', void 0),
                    Ve(this, '_scopeFire', void 0),
                    Ve(this, 'prepared', { name: null, axis: null, edges: null }),
                    Ve(this, 'pointerType', void 0),
                    Ve(this, 'pointers', []),
                    Ve(this, 'downEvent', null),
                    Ve(this, 'downPointer', {}),
                    Ve(this, '_latestPointer', { pointer: null, event: null, eventTarget: null }),
                    Ve(this, 'prevEvent', null),
                    Ve(this, 'pointerIsDown', !1),
                    Ve(this, 'pointerWasMoved', !1),
                    Ve(this, '_interacting', !1),
                    Ve(this, '_ending', !1),
                    Ve(this, '_stopped', !0),
                    Ve(this, '_proxy', null),
                    Ve(this, 'simulation', null),
                    Ve(
                        this,
                        'doMove',
                        (0, Yt.warnOnce)(function (t) {
                            this.move(t);
                    ...
                    },
                    {
                        ...
                        value: function (t, e, n) {
                            return (
                                ...
                                ((0, Yt.copyAction)(this.prepared, t),
                                (this.interactable = e),
                                (this.element = n),
                    ...
                    },
                    {
                        ...
                        value: function (t, e, n) {
                            ...
                            this.pointerIsDown &&
                                ...
                                (this.pointerWasMoved = (0, C.default)(r, o) > this.pointerMoveTolerance));
                            ...
                            i || B.setCoordVelocity(this.coords.velocity, this.coords.delta),
                                this._scopeFire('interactions:move', s),
                                i ||
                                    this.simulation ||
                                    (this.interacting() && ((s.type = null), this.move(s)),
                                    this.pointerWasMoved && B.copyCoords(this.coords.prev, this.coords.cur));
                        },
                    },
                    {
                        key: 'move',
                        value: function (t) {
                            (t && t.event) || B.setZeroCoords(this.coords.delta),
                                ((t = (0, j.default)(
                                    {
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            return 'mouse' === this.pointerType || 'pen' === this.pointerType
                                ...
                                : Z.findIndex(this.pointers, function (t) {
                                      return t.id === e;
                                  });
                        },
                    },
                    ...
                    },
                    {
                        ...
                        value: function (t, e, n, r) {
                            ...
                            return (
                                ...
                                a
                                    ? (a.pointer = t)
                                    : ((a = new Xe.PointerInfo(o, t, e, null, null)),
                                ...
                                B.setCoordDeltas(this.coords.delta, this.coords.prev, this.coords.cur),
                                r &&
                                    ((this.pointerIsDown = !0),
                                    (a.downTime = this.coords.cur.timeStamp),
                                    (a.downTarget = n),
                                    B.pointerExtend(this.downPointer, t),
                                    this.interacting() ||
                                        (B.copyCoords(this.coords.start, this.coords.cur),
    ...
    var on = (function () {
        function t(e) {
            !(function (t, e) {
                ...
                rn(this, 'active', !1),
                rn(this, 'isModified', !1),
                rn(this, 'smoothEnd', !1),
                rn(this, 'allowResume', !1),
                rn(this, 'modification', void 0),
                rn(this, 'modifierCount', 0),
                rn(this, 'modifierArg', void 0),
                rn(this, 'startCoords', void 0),
                rn(this, 't0', 0),
                rn(this, 'v0', 0),
                rn(this, 'te', 0),
                rn(this, 'targetOffset', void 0),
                rn(this, 'modifiedOffset', void 0),
                rn(this, 'currentOffset', void 0),
                rn(this, 'lambda_v0', 0),
                rn(this, 'one_ve_v0', 0),
                rn(this, 'timeout', void 0),
            ...
            (n = [
                {
                    ...
                    value: function (t) {
                        ...
                        if (
                            ...
                            (this.modifierArg = i.fillArg({
                                pageCoords: this.startCoords,
                                preEnd: !0,
                                phase: 'inertiastart',
                            })),
                            this.t0 - e.coords.cur.timeStamp < 50 && o > n.minSpeed && o > n.endSpeed)
                        )
                            this.startInertia();
                        else {
                ...
                },
                {
                    ...
                    value: function (t) {
                        ...
                        o.offsetBy({ x: -this.currentOffset.x, y: -this.currentOffset.y }),
                            ...
                            (0, B.copyCoords)(o.coords.prev, o.coords.cur),
                            this.stop();
                    },
                },
                {
                ...
                },
                {
                    ...
                    value: function () {
                        (this.active = this.smoothEnd = !1),
                            ...
                            jt.default.cancel(this.timeout);
                    },
                },
            ]) && nn(e.prototype, n),
            t
    ...
    var vn = (function () {
        function t(e) {
            !(function (t, e) {
                ...
                dn(this, 'options', void 0),
                dn(this, 'types', {}),
                dn(this, 'propagationStopped', !1),
                dn(this, 'immediatePropagationStopped', !1),
                dn(this, 'global', void 0),
    ...
    Object.defineProperty(gn, '__esModule', { value: !0 }),
        (gn.createInteractStatic = function (t) {
            ...
            return (
                (e.getPointerAverage = B.pointerAverage),
                (e.getTouchBBox = B.touchBBox),
                (e.getTouchDistance = B.touchDistance),
                (e.getTouchAngle = B.touchAngle),
                ...
                (e.on = (0, Yt.warnOnce)(function (t, e, n) {
                    if (
                        (i.default.string(t) && -1 !== t.search(' ') && (t = t.trim().split(/ +/)), i.default.array(t))
                    ) {
                    ...
                    return (
                        (0, hn.default)(t, this.scope.actions)
                            ? this.globalEvents[t]
                ...
                (e.off = (0, Yt.warnOnce)(function (t, e, n) {
                    if (
                        (i.default.string(t) && -1 !== t.search(' ') && (t = t.trim().split(/ +/)), i.default.array(t))
                    ) {
                        for (var r = 0; r < t.length; r++) {
    ...
    var xn = (function () {
        function t(n, r, o, i) {
            !(function (t, e) {
                ...
                bn(this, 'options', void 0),
                bn(this, '_actions', void 0),
                bn(this, 'target', void 0),
                bn(this, 'events', new cn.Eventable()),
                bn(this, '_context', void 0),
                bn(this, '_win', void 0),
                bn(this, '_doc', void 0),
                bn(this, '_scopeEvents', void 0),
                bn(this, '_rectChecker', void 0),
                (this._actions = r.actions),
                (this.target = n),
                (this._context = r.context || o),
                (this._win = (0, e.getWindow)((0, _.trySelector)(n) ? this._context : n)),
        ...
        return (
            ...
            (r = [
                ...
                },
                {
                    ...
                    value: function (t, e) {
                        return (
                            i.default.func(e.onstart) && this.on(''.concat(t, 'start'), e.onstart),
                            i.default.func(e.onmove) && this.on(''.concat(t, 'move'), e.onmove),
                            i.default.func(e.onend) && this.on(''.concat(t, 'end'), e.onend),
                            i.default.func(e.oninertiastart) && this.on(''.concat(t, 'inertiastart'), e.oninertiastart),
                            this
                        );
                    },
                },
                    ...
                    value: function (t, e) {
                        ...
                        for (var r in e) {
                            var o = r,
                                a = this.options[t],
                                s = e[o];
                            'listeners' === o && this.updatePerActionListeners(t, a.listeners, s),
                                i.default.array(s)
                                    ? (a[o] = Z.from(s))
                                    : i.default.plainObject(s)
                                    ? ((a[o] = (0, j.default)(a[o] || {}, (0, ge.default)(s))),
                ...
                },
                {
                    ...
                    value: function (t) {
                        return (
                            ...
                            i.default.string(this.target) && (t = t || this._context.querySelector(this.target)),
                        ...
                        return i.default.func(t)
                            ? ((this._rectChecker = t),
                              (this.getRect = function (t) {
                                  ...
                                  return (
                                      'width' in n || ((n.width = n.right - n.left), (n.height = n.bottom - n.top)), n
                                  );
                              }),
                              this)
                            : null === t
                    ...
                    value: function (t, e, n, r) {
                        ...
                        for (var s in a) {
                            ...
                            for (var l = 0; l < a[s].length; l++) {
                                var u = a[s][l];
                                (0, hn.default)(s, this._actions)
                                    ? this.events[t](s, u)
                                    : i.default.string(this.target)
                                    ? this._scopeEvents[''.concat(o, 'Delegate')](this.target, this._context, s, u, r)
                ...
                },
                {
                    ...
                    value: function (t) {
                        ...
                        (this.options = (0, ge.default)(e.base)),
                        this._actions.methodDict)) {
                            var r = n,
                                o = this._actions.methodDict[r];
                            (this.options[r] = {}),
                                this.setPerAction(r, (0, j.default)((0, j.default)({}, e.perAction), e.actions[r])),
                                this[o](t[r]);
                        }
            ...
            (n = [
                {
                    ...
                    value: function (t, e) {
                        ...
                        return (
                            ...
                            this.list.push(n),
                            i.default.string(t)
                                ? (this.selectorMap[t] || (this.selectorMap[t] = []), this.selectorMap[t].push(r))
    ...
    var kn = (function () {
        function t(e) {
            !(function (t, e) {
                ...
                Tn(this, 'currentTarget', void 0),
                Tn(this, 'originalEvent', void 0),
                Tn(this, 'type', void 0),
        ...
        install: function (t) {
                                ...
                                if (p.selector === t && p.context === e) {
                                    for (var v = p.listeners, h = v.length - 1; h >= 0; h--) {
                                        ...
                                        if (y === o && b === s.capture && x === s.passive) {
                                            v.splice(h, 1),
                                                v.length || (f.splice(a, 1), l(e, n, u), l(e, n, c, !0)),
                                                (d = !0);
                                            break;
                                        }
                                    }
            ...
            function s(t, e, r, o) {
                ...
                s || ((s = { eventTarget: t, events: {} }), n.push(s)),
                    ...
                    t.addEventListener &&
                        !Z.contains(s.events[e], r) &&
                        (t.addEventListener(e, r, a.supportsOptions ? i : i.capture), s.events[e].push(r));
            }
            function l(t, e, r, o) {
                var i = In(o),
                    ...
                    if ('all' !== e) {
                        ...
                        if (f) {
                            ...
                            for (var p = 0; p < f.length; p++)
                                if (f[p] === r) {
                                    t.removeEventListener(e, r, a.supportsOptions ? i : i.capture),
                                        f.splice(p, 1),
                                        0 === f.length && (delete u.events[e], (c = !0));
                                    break;
                                }
                        }
            ...
            function u(t, e) {
                for (
                    var n = In(e), o = new kn(t), a = r[t.type], s = Mn(B.getEventTargets(t), 1)[0], l = s;
                    i.default.element(l);
    ...
    function Hn(t, e) {
        var n = t.doc,
            ...
            a = r.events,
            s = a[e];
        for (var l in (r.browser.isIOS && !o.events && (o.events = { passive: !1 }), a.delegatedEvents))
    ...
    var sr = (function () {
        function t() {
            var e = this;
            rr(this, t),
                ar(this, 'id', '__interact_scope_'.concat(Math.floor(100 * Math.random()))),
                ar(this, 'isInitialized', !1),
                ar(this, 'listenerMaps', []),
                ar(this, 'browser', b.default),
                ar(this, 'defaults', (0, ge.default)(Me.defaults)),
                ar(this, 'Eventable', cn.Eventable),
                ar(this, 'actions', {
                    map: {},
                ...
                ar(this, 'interactStatic', (0, gn.createInteractStatic)(this)),
                ar(this, 'InteractEvent', je.InteractEvent),
                ar(this, 'Interactable', void 0),
                ar(this, 'interactables', new wn.InteractableSet(this)),
                ar(this, '_win', void 0),
                ar(this, 'document', void 0),
                ar(this, 'window', void 0),
                ar(this, 'documents', []),
                ar(this, '_plugins', { list: [], map: {} }),
                ...
                return (
                    ir(i, [
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                return (
                                    Qn(nr(i.prototype), 'set', this).call(this, t),
                        ...
                        },
                        {
                            key: 'unset',
                            value: function () {
                                Qn(nr(i.prototype), 'unset', this).call(this),
                ...
                },
                {
                    ...
                    value: function (t, n) {
                        ...
                        (n = n ? (0, j.default)({}, n) : {}),
                            ...
                            this.fire('scope:add-document', { doc: t, window: r, scope: this, options: n });
                    },
                },
                {
                    key: 'removeDocument',
                    value: function (t) {
                        ...
                        this.events.remove(r, 'unload', this.onWindowUnload),
                            ...
                            this.fire('scope:remove-document', { doc: t, window: r, scope: this, options: o });
                    },
                },
                {
                    key: 'getDocIndex',
            ...
            var e = [
                ...
                n = function (n, r) {
                    for (
                        var o = t.range,
                            i = t.limits,
                            a = void 0 === i ? { left: -1 / 0, right: 1 / 0, top: -1 / 0, bottom: 1 / 0 } : i,
                            s = t.offset,
    ...
    var Er = {
        ...
        set: function (t) {
            ...
            var s = e.subModification.setAll(
                    Or(Or({}, t), {}, { rect: a, edges: e.linkedEdges, pageCoords: r, prevCoords: r, prevRect: a })
                ),
                l = s.delta;
            return (
    ...
    var Cr = {
        start: function (t) {
            var e = t.rect,
                ...
                a = r.options,
                s = a.elementRect,
                l = (0, j.default)({ left: 0, top: 0, right: 0, bottom: 0 }, a.offset || {});
            if (e && s) {
    ...
    var Lr = {
        ...
        start: function (t) {
            ...
            (e = e || { x: 0, y: 0 }),
                (o.offset = { top: e.y + r.top, left: e.x + r.left, bottom: e.y - r.bottom, right: e.x - r.right });
        },
        set: function (t) {
            var e = t.coords,
                n = t.edges,
            ...
            if (n) {
                ...
                Wr(l, Yr),
                    ...
                    n.top
                        ...
                        : n.bottom && (e.y = Math.max(Math.min(u.bottom + i.bottom, s.y), l.bottom + i.bottom)),
                    n.left
                        ? (e.x = Math.min(Math.max(u.left + i.left, s.x), l.left + i.left))
                        : n.right && (e.x = Math.max(Math.min(u.right + i.right, s.x), l.right + i.right));
            }
        },
            ...
            var e,
                ...
                u = l.offsetWithOrigin
                    ? (function (t) {
                          ...
                          return (
                              (0, k.rectToXY)((0, k.resolveRectLike)(t.state.options.origin, null, null, [e])) ||
        ...
        set: function (t) {
            ...
            for (var c = 0; c < a.length; c++)
                for (var f = a[c], d = l.x - f.x, p = l.y - f.y, v = 0, h = o.targets.length; v < h; v++) {
                    var g,
                        y = o.targets[v];
                    (g = i.default.func(y) ? y(d, p, e._proxy, f, v) : y) &&
                        u.push({
            ...
            for (
                var m = { target: null, inRange: !1, distance: 0, range: 0, delta: { x: 0, y: 0 } }, b = 0;
                b < u.length;
                b++
            ) {
                var x = u[b],
                    ...
                    O = (0, C.default)(_, P),
                    S = O <= w;
                w === 1 / 0 && m.inRange && m.range !== 1 / 0 && (S = !1),
                    (m.target &&
                        !(S
                            ? m.inRange && w !== 1 / 0
                                ? O / w < m.distance / m.range
                                : (w === 1 / 0 && m.range !== 1 / 0) || O < m.distance
                            : !m.inRange && O < m.distance)) ||
                        ((m.target = x),
                        (m.distance = O),
                        (m.range = w),
                        (m.inRange = S),
    ...
    var So = (function (t) {
        ...
        function a(t, e, n, r, o, s) {
            ...
            if (
                ...
                Oo(_o((l = i.call(this, o))), 'type', void 0),
                Oo(_o(l), 'originalEvent', void 0),
                Oo(_o(l), 'pointerId', void 0),
                Oo(_o(l), 'pointerType', void 0),
                Oo(_o(l), 'double', void 0),
                Oo(_o(l), 'pageX', void 0),
                Oo(_o(l), 'pageY', void 0),
                Oo(_o(l), 'clientX', void 0),
                Oo(_o(l), 'clientY', void 0),
                Oo(_o(l), 'dt', void 0),
                Oo(_o(l), 'eventable', void 0),
                B.pointerExtend(_o(l), n),
                n !== e && B.pointerExtend(_o(l), e),
                (l.timeStamp = s),
                (l.originalEvent = n),
                (l.type = t),
                (l.pointerId = B.getPointerId(e)),
                (l.pointerType = B.getPointerType(e)),
                (l.target = r),
    ...
    var To = {
        ...
        install: function (t) {
            (t.pointerEvents = To),
                (t.defaults.actions.pointerEvents = To.defaults),
                (0, j.default)(t.actions.phaselessTypes, To.types);
        },
        listeners: {
            'interactions:new': function (t) {
                var e = t.interaction;
            ...
            'interactions:move': function (t, e) {
                ...
                t.duplicate ||
                    ...
                    (n.pointerIsDown && ko(t),
                    Mo({ interaction: n, pointer: r, event: o, eventTarget: i, type: 'move' }, e));
            },
            'interactions:down': function (t, e) {
                !(function (t, e) {
                    for (
                ...
                ko(t),
                    ...
                    (function (t, e) {
                        var n = t.interaction,
                            ...
                            i = t.eventTarget;
                        n.pointerWasMoved ||
                            Mo({ interaction: n, eventTarget: i, pointer: r, event: o, type: 'tap' }, e);
                    })(t, e);
            },
    ...
    function Mo(t, e) {
        ...
        for (
            var c = { interaction: n, pointer: r, event: o, eventTarget: i, targets: l, type: a, pointerEvent: u },
                f = 0;
            f < l.length;
            f++
        ) {
    ...
    function jo(t, e) {
        ...
        for (
            var u = _.getPath(i),
                c = { interaction: n, pointer: r, event: o, eventTarget: i, type: a, path: u, targets: [], node: null },
                f = 0;
            f < u.length;
            f++
        ) {
        ...
        return (
            'hold' === a &&
                (c.targets = c.targets.filter(function (t) {
                    var e;
                    return (
                        t.eventable.options.holdDuration === (null == (e = n.pointers[s]) ? void 0 : e.hold.duration)
                    );
                })),
            c.targets
        );
                        ...
                        a <= 0 ||
                            (n.holdIntervalHandle = setTimeout(function () {
                                e.pointerEvents.fire(
                                    { interaction: n, eventTarget: o, type: 'hold', pointer: r, event: r },
                                    e
                                );
                            }, a));
                    }
    ...
    function Wo(t) {
        ...
        (t.actions.phases.reflow = !0),
            (e.prototype.reflow = function (e) {
                return (function (t, e, n) {
                    for (
                        var r = i.default.string(t.target) ? Z.from(t._context.querySelectorAll(t.target)) : [t.target],
                            o = n.window.Promise,
                            a = o ? [] : null,
                            s = function () {
                                var i = r[l],
                                ...
                                if (u)
                                    ...
                                    c = (function (t, e, n, r, o) {
                                        ...
                                        (i.interactable = e),
                                            ...
                                            B.setZeroCoords(i.coords.delta),
                                            (0, Yt.copyAction)(i.prepared, r),
                                            i._doPhase(a);
                                        ...
                                        return (
                                            (i._reflowPromise = l),
                                            i.start(r, e, n),
                                            i._interacting ? (i.move(a), i.end(o)) : (i.stop(), i._reflowResolve()),
                                            i.removePointer(o, o),
                                            l
                                        );
                                    })(n, t, i, e, p);
        ...
        listeners: {
            'interactions:stop': function (t, e) {
                ...
                'reflow' === n.pointerType &&
                    (n._reflowResolve && n._reflowResolve(), Z.remove(e.interactions.list, n));
            },
        },
    };
    Bo.default = Lo;
    ...
    Object.defineProperty(Uo.exports, '__esModule', { value: !0 }),
        (Uo.exports.default = void 0),
        cr.default.use(se.default),
        cr.default.use(Ge.default),
        cr.default.use(Xo.default),
        cr.default.use(en.default),
        cr.default.use(ho.default),
        cr.default.use(ie.default),
        cr.default.use(Tt.default),
        cr.default.use(Rt.default),
        cr.default.use(Bo.default);
    var No = cr.default;
    if (((Uo.exports.default = No), 'object' === Vo(Uo) && Uo))
        try {
    ...
    var Go = Uo.default;
    if (((qo.exports.default = Go), 'object' === $o(qo) && qo))
        try {
